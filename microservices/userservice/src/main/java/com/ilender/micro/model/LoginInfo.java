...
public class LoginInfo {
    ...
    boolean userRoleFieldAgent = false;
    ...
    public boolean isUserRoleFieldAgent() {
        return userRoleFieldAgent;
    }

    public void setUserRoleFieldAgent(boolean userRoleFieldAgent) {
        this.userRoleFieldAgent = userRoleFieldAgent;
    }
