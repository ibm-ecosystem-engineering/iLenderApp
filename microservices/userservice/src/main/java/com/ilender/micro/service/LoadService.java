...
public class LoadService {
    ...
    public static String startConsumeMemoryAndThenSleep(int increaseSizeInKB, int maxIncreaseSizeInKBIn, long initialSleepMilliSeconds, long incrementSleepMilliSeconds, long incrementSleepForRequest) {
