...
import com.ilender.micro.util.HttpClientUtil;
...
public class RestUtilService {
    ...
    public ResponseEntity<String> callExchange (String url, HttpMethod httpmethod, HttpEntity requestInfo) {
        ...
        try {
            response = restTemplate.exchange(url, httpmethod,  requestInfo, String.class);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return response;
    ...
    public String callGet(String url) {
        ...
        String outputInfo =callHttpClient(url);
...
//            e.printStackTrace();
    ...
    public Object callGetForEntity (String url) {
...
//            result  = ConversionUtil.objectToJsonString(result);
        } catch (Exception e) {
//            e.printStackTrace();
        }
    ...
    public Object callHttpClient2(String url, Class returnClass) {
        LogUtil.logDebug("RestUtilService : callHttpClient started");
        ...
        try {
            ...
            result =  (Object) ConversionUtil.jsonToObject((String) result, returnClass);
        } catch (Exception e) {
//            e.printStackTrace();
        }
