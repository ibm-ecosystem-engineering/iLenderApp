...
//            webb.setBaseUri(getLogDNAURL());
            ...
            webb.setDefaultHeader(Webb.HDR_AUTHORIZATION, "Basic " + "3333");
            this.http = webb;
        }
        return this.http;
    }
    private Webb getHttp111() {
        if (this.http == null) {
            Webb webb = Webb.create();
            webb.setBaseUri("https://aaa.com/logs/ingest");
            webb.setDefaultHeader(Webb.HDR_USER_AGENT, "LogDNA Appender (95point2)");
            webb.setDefaultHeader(Webb.HDR_AUTHORIZATION, "Basic " + "444444");
            this.http = webb;
        }
        return this.http;
    }
