...
public class HumioService {
    ...
    public static String SERVICE_NAME_FOR_LOG = "creditscoreservice";
    ...
    private void callPost(String apiUrl, String accessToken, Object inputInfo) {
        ...
        LogUtil.logInfo("HumioService: callPost: apiUrl : " + apiUrl);
        LogUtil.logInfo("HumioService: callPost: accessToken : " + accessToken);
